...
# *************************************************************************
# Method-1
num1, num2, num3, num_com = 8, 11, 7, 0

if num1 > num2:
    if num1 > num3:
        print("Result by Method-1 --> Num1 is greatest")

    else:
        print("Result by Method-1 --> Num3 is greatest")

elif num1 > num3:
    if num1 > num2:
        print("Result by Method-1 --> Num2 is greatest")
